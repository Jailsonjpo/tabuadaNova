...
class QuizModel with ChangeNotifier {
  ...
  void checkAnswer(int answer, BuildContext context) {
    ...
    if (_questionNumber >= _totalQuestions) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ResultPage(score: _score, totalQuestions: _totalQuestions, wrongQuestions: _wrongQuestions)),
      );
    } else {
      _nextQuestion();
    }
                  ...
                  return ElevatedButton(
                    onPressed: () {
                      Provider.of<QuizModel>(context, listen: false)
                          .setMultiplier(table);
                      Provider.of<QuizModel>(context, listen: false)
                          .setTotalQuestions(_selectedQuestions);
                      Navigator.push(
                        context,
